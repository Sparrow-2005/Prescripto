...
const MyProfile = () => {
  ...
  const updateUserProfileData = async () => {
    try {
      ...
      const {data}=await axios.post(backendUrl + "/api/user/update-profile", formData, {headers: { 'Authorization': token}});
      if (data.success) {
  ...
  return userData && (
    <div className="max-w-lg flex flex-col gap-2 text-sm">
      ...
      <div>
        ...
        <div className="grid grid-cols-[1fr_3fr] gap-y-2.5 mt-3 text-neutral-7 00">
